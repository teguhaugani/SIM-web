...
<section id="About">
    ...
    <table class="table table-bordered">
        ...
        <?php
            ...
            $no=0;
            $query=mysqli_query($koneksi,"select * from tb_pekerja
            tb_biodata join tb_biodata tb_pekerja on tb_biodata.id_biodata=tb_pekerja.id_biodata");
        ...
        ?>
            <tr>
                ...
                <td><?php echo $panggil['nama_pekerja'] ?></td>
                <td><?php echo $panggil['gaji'] ?></td>
                <td><?php echo $panggil['tanggal_mulai'] ?></td>
                <td><?php echo $panggil['tanggal_sampai'] ?></td>
            </tr>
        <?php
        }
        ?>
