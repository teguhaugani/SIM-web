...
<section class="content">
	<div class="box box-primary">
		<div class="box-header with-border">
			<a href="?page=MyApp/add_nilai" title="Tambah Data" class="btn btn-primary">
                ...
                ?>
						...
						<tr>
							...
							<td>
								...
								<a href="?page=MyApp/view_nilai&kode=<?php echo $data['id_nilai']; ?>" title="Lihat"
								 class="btn btn-success">
									<i class="glyphicon"><img src="images/lht.png" width=15 height=20></i>
								</a>
								<a href="?page=MyApp/cetak_nilai&kode=<?php echo $data['id_nilai']; ?>" title="Print" target="_blank"
