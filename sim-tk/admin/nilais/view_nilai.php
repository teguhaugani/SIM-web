		...
		<div class="col-md-12">
			...
			<div class="box box-success">
				<div class="box-header with-border">
					<a href="?page=MyApp/data_nilais" class="btn btn-primary">
					<i class="glyphicon glyphicon-arrow-left"></i> Kembali</a>
					<!-- <a href="./report/cetak-nilai.php" target=" _blank"
				...
				<form action="" method="post" enctype="multipart/form-data">
					...
					<div class="box-footer">
						...
						<a href="?page=MyApp/data_nilais" class="btn btn-warning">Kembali</a>
					</div>
				</form>
			</div>
			<!-- /.box -->
