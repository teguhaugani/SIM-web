			...
			<div class="box box-info">
				...
				<form action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							<label>NIS</label>
							<input name="id_nilai" id="id_nilai" class="form-control" placeholder="NIS">
						</div>
					...
					<div class="box-footer">
						...
						<a href="?page=MyApp/data_nilais" class="btn btn-warning">Batal</a>
					</div>
				</form>
			</div>
			<!-- /.box -->
...
<?php
    ...
    if (isset ($_POST['Simpan'])){
        ...
        $sql_simpan = "INSERT INTO tb_nilai (nis,id_nilai,n11,n12,n13,n14,n21,n22,n23,n24,n31,n32,n41,n42,n43,n44,n45,n51,n52,n53,n54,n61,n62,n71,n72,n73,n74,n81,n82,n83,n84) VALUES (
           '".$_POST['nis']."',
		   '".$_POST['id_nilai']."',
		   '".$_POST['n11']."',
		   '".$_POST['n12']."',
    ...
    if ($query_simpan){
      ...
      Swal.fire({title: 'Tambah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
          ...
          if (result.value) {
              window.location = 'index.php?page=MyApp/data_nilais';
          }
      })</script>";
      }else{
      echo "<script>
      Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
          ...
          if (result.value) {
              window.location = 'index.php?page=MyApp/add_nilais';
          }
      })</script>";
    }
  }
