                ...
                ?>
						...
						<tr>
							...
							<td>
								...
								<a href="?page=MyApp/view_nilaip&kode=<?php echo $data['id_nilai']; ?>" title="Lihat"
								 class="btn btn-success">
									<i class="glyphicon"><img src="images/lht.png" width=15 height=20></i>
								</a>
								<a href="?page=MyApp/cetak_nilaip&kode=<?php echo $data['id_nilai']; ?>" title="Print" target="_blank"
